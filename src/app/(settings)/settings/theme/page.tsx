...
const menuItems: SettingItem[] = [
  ...
  { active: true, id: "theme", title: "Theme", description: "Appearance and theme settings" },
];

const items: SettingItem[] = [
  { id: "theme", title: "Change default theme", description: "Select a theme to better fit your personal preferences" },
];
              ...
              <CardContent>
                <div key={items[0].id} className="flex gap-4 items-center mb-4">
                  ...
                  <div className="flex-1/4">
                    ...
                    <span className="text-sm text-slate-500">Current: {resolvedTheme}</span>
                  </div>
                </div>
